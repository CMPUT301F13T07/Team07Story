...
//TODO: Discuss with team concerning my modification of attribute 'String text' to
//		'StringExtended text'.
public class Page {
	private Integer id;
    private String title;
    private String author;
	private StringExtended text;
	private Page parent;
	...
	*/
    public Page(Integer id, String title, String author, StringExtended text, ArrayList<Page> pages) {
		this.id = id;
		this.title = title;
		this.author = author;
		this.text = text;
    ...
    public Page(String title, String author, StringExtended text, ArrayList<Page> pages) {
		this.id = null;
		this.title = title;
		this.author = author;
		this.text = text;
	...
	public void setText(StringExtended t) {text = t;}
	public StringExtended getText() {return text;}
